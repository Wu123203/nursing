        ...
        <div class="box-card">
          <el-card>
            ...
            <el-table v-loading="loading" :data="tableData" border stripe>
              ...
              <el-table-column prop="title" label="护工名">
              ...
              <el-table-column label="操作" fixed="right" width="110">
                <template #default="scope">
                  <el-dropdown size="small" split-button>
                    ...
                    <template #dropdown>
                      <el-dropdown-menu>
                        <el-dropdown-item icon="Delete" class="danger" @click="handleDelete(scope.row)">取消</el-dropdown-item>
                      </el-dropdown-menu>
                    </template>
                  </el-dropdown>
                </template>
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('确定要删除吗？', '提示', {
        ...
        this.$http.delete("/like/" + row.id).then(res => {
          if (res.code === 200) {
            this.$message({
              type: "success",
              message: res.msg
